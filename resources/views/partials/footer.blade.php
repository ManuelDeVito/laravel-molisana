<footer>
    <div class="contenitore">
        <div class="contenitore-footer">
            <div class="contenitore-indirizzi">
                ...
                <ul>
                    ...
                    <li>info@lamolisana.it (per segnalazione degli utenti)</li>
            ...
            <div class="contenitore-pastificio">
                <h2>Panificio</h2>
                <ul>
                    <li>Il Pastificio</li>
                ...
                <h2 class="title-prodotti">Prodotti</h2>
                <ul>
                    <li>Le Classiche</li>
                    <li>Le Integrali</li>
                    <li>Le Speciali</li>
